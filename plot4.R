...
data$Global_reactive_power = as.numeric(type.convert(as.character(data$Global_reactive_power), dec = "."))
data$Voltage = as.numeric(type.convert(as.character(data$Voltage), dec = "."))
...
legend("topright", colnames(data[c(7,8,9)]), col=c('black','red','blue'), lty=1, bty="n", cex=.95)
